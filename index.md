...
By AKU class: **965 concept**, **179 method**, **1239 claim** · all `unvalidated` · `sourced` mayoría at `llm_confidence: 0.50`, ~21 `sourced` at `0.60` (post-dedup/merge), 3 at `0.70` (lead-magnet, cltv-cac-ratio, churn-rate — 3 fuentes c/u), 1 `sourced` at `0.20` (mas-valor-menos-coste), 1 `tacit` at `null` (Joan's free-bootstrap-plataforma claim).
