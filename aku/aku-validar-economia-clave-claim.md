...
type: aku
aku_class: claim
id: aku-validar-economia-clave-claim
statement: >
  Antes de optimizar canales y escalar hay que validar la economía clave
  del modelo de negocio —que puede ser rentable y que su unit economics
  (relación CLTV/CAC) se sostiene—; escalar un modelo cuya economía clave
  aún no está validada multiplica una rentabilidad incierta en lugar de
  un modelo verificado.
origin: "The Power MBA — Módulo 3 «Lean Startup / Testing»"
domain: [lean-startup, unit-economics, validacion, testing, power-mba]
