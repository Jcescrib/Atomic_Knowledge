...
type: aku
aku_class: concept
id: aku-cualificar-afiliado-cliente-experto-concept
statement: >
  Se cualifica al afiliado haciéndole invertir (tiempo, dinero, en el producto)
  por dos vías: hacerle cliente (que compre y use el producto para mantener su
  estatus) y hacerle experto (que pague el onboarding/certificación); incluye
  que cobrar la certificación 10-20% de lo que gana un afiliado activo al año
  maximiza el nº de afiliados activos; implica «si pagan, prestan atención».
