...
statement: >
  Leverage (apalancamiento, en el sentido de Naval) es un multiplicador de
  fuerza para tu juicio: las fortunas lo requieren; incluye tres fuentes
  —capital (dinero), labor (personas trabajando para ti) y productos con coste
  marginal de replicación nulo (código y medios)—; excluye el mero trabajo duro
  sin palanca; implica que aplicar specific knowledge con accountability y
  leverage produce resultados desproporcionados.
origin: "Naval Ravikant — The Almanack of Naval Ravikant (ed. Eric Jorgenson, 2020)"
domain: [riqueza, naval, leverage, apalancamiento]
