...
type: aku
aku_class: claim
id: aku-thread-of-why-conectar-al-individuo-claim
statement: >
  Explicar el porqué no basta: el porqué debe tener un «hilo» que conecte de
  vuelta con cada persona de la cadena (el «beneficio para los accionistas» no
  motiva a la primera línea; hay que atarlo a su seguridad laboral, crecimiento
  y oportunidades); enmarca el porqué desde la perspectiva de la tropa,
  mostrando cómo la misión les impacta a ELLOS.
origin: "Jocko Willink, Leadership Strategy and Tactics: Field Manual (2020)"
domain: [liderazgo, jocko, comunicacion, proposito, motivacion]
