...
By AKU class: **24 concept**, **2 method**, **5 claim** · all `unvalidated` · all `epistemic_type: sourced` · all `llm_confidence: 0.50`.

_Last updated: 2026-06-03 (pipeline ingest #3: 2.2-motores métricas)_
