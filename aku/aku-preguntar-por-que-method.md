...
type: aku
aku_class: method
id: aku-preguntar-por-que-method
statement: >
  Cuando un líder recibe una orden que cuestiona o no entiende, debe preguntar
  «¿por qué?»: dar un paso atrás, deconstruir la situación, analizar el cuadro
  estratégico y llegar a una conclusión; si no encuentra por sí mismo una
  respuesta satisfactoria, debe preguntar hacia arriba en la cadena de mando
  hasta entenderlo.
...
**supported_by** ← [[aku-detach-tactico-estrategico-concept]] · [[aku-preguntar-requiere-coraje-claim]]
