...
type: aku
aku_class: claim
id: aku-evolucionar-mas-alla-del-rol-asignado-crea-nuevos-modelos-de-exito-claim
statement: >
  Evolucionar más allá del rol y las expectativas que te asignaron permite crear modelos de
  éxito nuevos: el agente David Falk, en vez de repetir el playbook de endorsements, hizo de
  Michael Jordan una marca de estilo de vida con royalties («Air Jordan»), revolucionando el
  marketing deportivo. No conformarse con la rutina asignada, sino empujar el cambio desde
  dentro, transforma tanto tu carrera como tu industria.
origin: "Curtis «50 Cent» Jackson — Hustle Harder, Hustle Smarter (2020)"
domain: [50-cent, evolution, innovation, business]
