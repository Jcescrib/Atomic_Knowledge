...
type: aku
aku_class: concept
id: aku-color-psychology-el-significado-del-color-depende-del-contexto-y-la-experiencia-concept
statement: >
  El significado de un color no es intrinseco: depende de la experiencia pasada y solo es universal si todos lo ven en el mismo contexto (rojo/naranja son «calidos» porque todos sienten calor con el fuego o el sol). El color tiene tres componentes —hue (categoria), saturacion (vividez) y value (brillo)—, y las preferencias surgen de la evolucion y de la teoria de valencia ecologica (se prefiere el color asociado a experiencias positivas). Esos componentes generan significados universales (peso, tamano, proximidad, lujo, accion).
origin: "Nick Kolenda — Color Psychology"
domain: [kolenda, color, color, perception, branding, marketing-psychology]
...
relations:
  supported_by:
    ...
    - aku-esquema-de-color-triadico-claim
...
**related** ↔ [[aku-identidad-de-marca-concept]] · [[aku-font-psychology-las-fuentes-significan-por-congruencia-de-rasgos-concept]] · [[aku-el-entorno-es-la-mano-invisible-que-moldea-la-conducta-claim]] · [[aku-the-tangled-mind-la-cognicion-es-corporal-embodied-concept]] · [[aku-blending-los-sonidos-adquieren-significado-por-mezcla-concept]]
