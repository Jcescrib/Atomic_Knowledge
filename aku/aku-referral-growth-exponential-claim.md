...
statement: >
  Los referidos hacen crecer el negocio de forma exponencial (1 cliente trae 2,
  2 traen 4…), a diferencia del crecimiento lineal de la Core Four; además valen
  más (mayor LTGP: compran más caro, más veces y por adelantado) y cuestan menos
  (CAC cercano a cero); el crecimiento neto es referidos − churn, y si el % de
  referidos supera al % de churn el negocio compone cada mes sin más publicidad.
origin: "Alex Hormozi — $100M Leads"
domain: [marketing-digital, referidos, crecimiento, viralidad, hormozi]
