...
statement: >
  Una vez elegido un mercado o nicho hay que comprometerse con él el tiempo
  suficiente para iterar por prueba y error; saltar de nicho en nicho («niche
  slap») reinicia el aprendizaje desde cero y reduce la probabilidad de éxito,
  porque todo mercado normal tiene características desagradables y «la hierba no
  es más verde al otro lado».
origin: "Alex Hormozi — $100M Offers"
domain: [estrategia, nicho, emprendimiento, hormozi]
