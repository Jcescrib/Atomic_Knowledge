...
statement: >
  En blitzscaling no puedes resolver todos los problemas: en las caóticas etapas de
  crecimiento "el fuego arde por todas partes", así que hay que decidir cuáles son
  los incendios esenciales que apagar y dejar que el resto ardan; es el arte de
  entender qué es lo verdaderamente importante y centrarse en eso (priorización).
origin: "Reid Hoffman & Chris Yeh — «Blitzscaling»; The Power MBA — Módulo 4.5"
domain: [estrategia, crecimiento, blitzscaling, gestion, priorizacion, power-mba]
