...
Graph: **1 connected component** (1127 nodos: 1044 AKU + 83 TAKU), 0 bidirectional errors (1044/1044 simétrico, 0 body-drift, 0 wikilinks rotos, 0 huérfanos — verificado por `scripts/verify_graph.py`). **389 AKUs llevan el source-tag `hormozi`** (130 de la 1ª ingesta + 259 de la reingesta diferencial hiper-exhaustiva).
