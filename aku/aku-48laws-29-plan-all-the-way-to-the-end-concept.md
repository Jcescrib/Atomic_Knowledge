...
type: aku
aku_class: concept
id: aku-48laws-29-plan-all-the-way-to-the-end-concept
statement: >
  La Ley 29 de Greene, «planifica hasta el final», sostiene que el final lo es
  todo: planifica hasta él teniendo en cuenta todas las consecuencias,
  obstáculos y giros de fortuna posibles que podrían revertir tu trabajo y dar
  la gloria a otros, para no verte abrumado por las circunstancias.
origin: "Robert Greene — The 48 Laws of Power (1998)"
domain: [poder, robert-greene, 48-laws, ley-29, planificacion]
