...
type: aku
aku_class: concept
id: aku-clausula-formato-contenidos-concept
statement: >
  El formato de los contenidos es la cláusula que define el soporte y los medios técnicos
  del contenido contratado; incluye el tipo de pieza (una foto, una story de Instagram,
  un post con texto en un blog, un vídeo de YouTube) y opcionalmente los medios técnicos
  de creación (tipo de cámara de vídeo/foto, herramientas de edición); implica acordar el
  canal y la calidad de producción esperados de la publicación.
