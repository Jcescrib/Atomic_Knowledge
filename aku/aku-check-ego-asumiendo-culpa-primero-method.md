...
type: aku
aku_class: method
id: aku-check-ego-asumiendo-culpa-primero-method
statement: >
  Para desactivar un choque de egos con un subordinado, el líder controla su
  propio ego asumiendo primero la culpa («nuestro equipo cometió un error y es
  culpa mía; no fui tan claro como debía»); al quitar el ego de en medio, el
  otro puede ver el problema sin la visión nublada por su propio ego, en lugar
  de enfrentarse en un choque de egos.
origin: "Jocko Willink & Leif Babin, Extreme Ownership (2015)"
domain: [liderazgo, jocko, ego, comunicacion, responsabilidad]
