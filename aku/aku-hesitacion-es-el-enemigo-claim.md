...
type: aku
aku_class: claim
id: aku-hesitacion-es-el-enemigo-claim
statement: >
  La hesitación es el enemigo: el miedo en el momento entre decidir y actuar
  causa vacilación, y la vacilación causa la derrota (deja pasar el momento,
  pierde la oportunidad, da ventaja al enemigo y deviene en cobardía); para
  ganar hay que superar ese instante —ir, moverse, tomar la acción, no esperar—.
origin: "Jocko Willink, Discipline Equals Freedom: Field Manual (2017)"
domain: [liderazgo, jocko, disciplina, decision, accion]
