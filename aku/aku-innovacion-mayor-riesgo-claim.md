...
type: aku
aku_class: claim
id: aku-innovacion-mayor-riesgo-claim
statement: >
  A mayor innovación de la propuesta, mayor es el riesgo del proyecto: las
  propuestas más innovadoras (crear algo nuevo o entrar con una propuesta
  rompedora) conllevan más incertidumbre y mayor probabilidad de fracaso que
  competir en un mercado existente con una propuesta conocida.
origin: "The Power MBA — Módulo 6.1 «Fit entre tu proyecto y tú»"
domain: [emprendimiento, modelo-de-negocio, riesgo, innovacion, power-mba]
