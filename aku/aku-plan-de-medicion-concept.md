...
statement: >
  El plan de medición es el marco que conecta los objetivos de negocio con su
  medición analítica a través de cinco bloques: Objetivos (qué quieres lograr, con
  conversiones macro y micro), Estrategias (el cómo, las acciones para lograrlos),
  KPIs (pocas métricas relevantes que monitorizan el avance), Metas (valores
