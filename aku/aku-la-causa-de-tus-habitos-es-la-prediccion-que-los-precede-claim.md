...
type: aku
aku_class: claim
id: aku-la-causa-de-tus-habitos-es-la-prediccion-que-los-precede-claim
statement: >
  La causa real de tus hábitos es la predicción que los precede: la vida se
  siente reactiva pero es predictiva —cada acción va precedida de una predicción
  sobre qué hacer—, y tu conducta depende de cómo interpretas los eventos, no de
  su realidad objetiva; el mismo cue (un cigarrillo) dispara un buen o mal
  hábito según tu predicción, así que reprogramar la predicción cambia el
  hábito.
origin: "James Clear — Atomic Habits (2018)"
domain: [james-clear, habitos, prediccion, interpretacion]
