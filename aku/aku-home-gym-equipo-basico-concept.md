...
statement: >
  El gimnasio en casa elimina excusas y puede estar en cualquier sitio (garaje,
  sótano, habitación, patio); el equipo básico esencial es: barra de dominadas,
  anillas de gimnasia, y un squat rack (con barra de dominadas y dip) más barra
  olímpica y discos bumper; con eso basta para una forma física excepcional;
  extras (kettlebells, remo, GHD, etc.) son útiles pero no necesarios.
origin: "Jocko Willink, Discipline Equals Freedom: Field Manual (2017)"
domain: [jocko, fisico, salud, entrenamiento, equipamiento]
