...
statement: >
  Dile a cada miembro del equipo —y créelo— que es el más importante, porque en
  cualquier momento cualquiera puede volverse el más importante y su fallo en un
  instante crítico puede ser catastrófico; explícale, incluso al del trabajo más
  menial, qué pasa si no hace bien su parte y cómo encaja en la misión
  estratégica.
