...
statement: >
  Ser un juez astuto del carácter es la mayor habilidad del emprendedor exitoso —por
  encima de negociar, planificar o entender tecnología—: nadie triunfa solo, así que
  rodearse de las personas correctas (que apoyen, hagan crecer y articulen tu visión)
  construye el equipo que te lleva a la cima, mientras que poner a la persona equivocada
  en un rol crítico puede ser catastrófico.
origin: "Curtis «50 Cent» Jackson — Hustle Harder, Hustle Smarter (2020)"
domain: [50-cent, crew, character-judgment, leadership]
...
relations:
  ...
  contradicts: []
  related:
    - aku-la-traicion-duele-mas-que-el-robo-claim
